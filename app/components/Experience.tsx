...
const experience: Role[] = [
  ...
  {
    title: "HND in Computer Engineering",
    company: "Polytechnic",
    period: "2021 — 2024",
    type: "Education",
    description:
      "Studied core computer engineering concepts with a focus on hardware-software integration, digital electronics, and network infrastructure.",
    achievements: [
      "Graduated with strong foundation in computer architecture, systems programming, and network design",
      "Completed capstone project on AI-assisted test generation, combining NLP with automated browser testing",
      "Developed networking projects including packet analysis, intrusion detection, and infrastructure routing",
      "Active in technology societies and hackathons, building automated tools under tight deadlines",
    ],
    tech: [
